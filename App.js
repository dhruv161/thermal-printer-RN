...
const Printer = () => {
  ...
  printTextTest = () => {
    currentPrinter && BLEPrinter.printText("<C>fuck ios</C>\n");
  }
...
//      peripheral.name && peripherals.set(peripheral.id, peripheral);
//      peripheral.name && setList(Array.from(peripherals.values()));
//    };
...
//     connectPrinter = (item) => {
//     //connect printer
//     console.log('printer.inner_mac_address', item)
//     BLEPrinter.connectPrinter('AA02E6C0-E9A5-355D-5954-2344A76A6ED9').then(
//       setCurrentPrinter,
//       error => console.warn(error))
//   } 
...
//      return (
//        <TouchableHighlight onPress={() => {connectPrinter(item)}}>
...
//   printBillTest = () => {
//     currentPrinter && BLEPrinter.printBill("<C>Fuck Ios</C>");
//   }
